...
def get_closest_city_and_resource(city_tiles, resource_cluster):
    ...
    logging.info(f'###########################: closest city tile: {closest_city_tile.pos.x}/{closest_city_tile.pos.y}\n')
    logging.info(f'###########################: closest resource tile: {closest_resource_tile.pos.x}/{closest_resource_tile.pos.y}\n')
    logging.info(f'###########################: Shortest distance: {shortest_dist}\n')
